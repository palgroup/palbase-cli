...
var stackImages = []struct{ env, fallback, build string }{
	{"PALBASE_PALSVC_IMAGE", "ghcr.io/palgroup/palbase/palsvc:0.40.1",
		"cd v2 && DOCKER_BUILDKIT=1 docker build -t palbase-palsvc -f Dockerfile ."},
	{"PALBASE_RUNTIME_IMAGE", "ghcr.io/palgroup/palbase/runtime-dev:0.40.1",
	...
	// line that builds it.
	{"PALBASE_EDGE_IMAGE", "ghcr.io/palgroup/palbase/edge:0.40.1",
